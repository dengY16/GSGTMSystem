	...
	init: function( editor ) {
		var lang = editor.lang,
			...
			allowedContent = {
				...
				textfield: 'input[type,name,value,size,maxlength,required]{border-color}',
				textarea: 'textarea[cols,rows,name,required]{border-style,border-width,border-color,resize}',
