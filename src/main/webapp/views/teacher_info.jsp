	...
	<div class="easyui-layout" fit="true" >
		<div data-options="region:'north',border:false"
			...
			<div style="float:left;">
			    <div>
				   <span>专业方向：</span>
			       <select id="selectMajors" class="easyui-combobox" 
			            data-options="
                        valueField: 'value',
                        textField: 'name',
                        method:'get',
                        mode:'remote',
                        url: '${ctx}/common/getMajorType'"
                        style="width: 250px">
                   </select>
	  ...
	  <div style="padding:10px 60px 20px 60px">
	    <form id="teacher" >
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>教师编号:&nbsp;</td>
	    			<td><input class="easyui-textbox" type="text" id="teacherCode" 
	    			data-options="required:true" style="width: 250px"></input></td>
	    		</tr>
	    	   <tr style="height:10px;"></tr>
	    		<tr>
		...
		//添加
		 $("#add").click(function(){
			   ...
			   $("#flag").val('add');
				...
				$("#teacherCode").textbox("setValue",'');
				$("#teacherName").textbox("setValue",'');
				$("#majors").combobox('setValue',''); 
		 ...
		 $("#confirm").click(function(){
				var flag=$("#flag").val(); 
				 ...
				 var params = new Object();
			        params.teacherCode = $("#teacherCode").val();
			        params.teacherName = $("#teacherName").val();
			        params.majors = $("#majors").combobox('getValue');
			        params.sex = $("#sex").val();
			        params.phone = $("#phone").val();
			      
				if(flag=='add'){
					 if(!$("#teacher").form("validate")){
				  		 parent.$.messager.alert('检查','请检查必填项');
				  		 return;
			       }
				    $.post("${ctx}/teacher/add",params,function(param){
						if(param.success==true){
						    $('#dd').dialog('close');
						    $('#dg').datagrid('reload')
